...
$args = arg($_GET["cat"],$_GET["tax"],$_GET["search"],$_GET["location"],$post_actual);    

$user_actual = $current_user->ID;  
$user_tarea = get_post($post_actual)->post_author; $title_tarea = get_the_title(); $id_tarea = get_the_ID(); $monto_salary = get_post_meta( get_the_ID(), '_job_salary', true ); $email_empleador = get_the_author_meta( 'user_email' ); 
                    ...
                    <div class="main-task__minigrid">
                        ...
                        <div class="main-taks__date">
                            ...
                            <div class="contenido">
                                ...
                                <div class=" datos_presupuesto main-presupuesto__mobile">
                                  <div class="presupuesto_minicard">
                                    ...
                                    <?php if (is_user_logged_in() != NULL && meta_user_value( 'user_registration_radio_1600171615', $current_user->ID ) == "Hacer tareas" ){ $title_tarea2 = $title_tarea."-".meta_user_value( 'first_name', $current_user->ID ); ?>
                                      <a href="" class="btn-oferta" data-toggle="modal" data-target="#publicar" onclick="monto_salary2('<?php echo $title_tarea2 ?>','<?php echo $title_tarea ?>','<?php echo $post_actual ?>','<?php echo user_value($user_actual) ?>','<?php echo meta_user_value( 'first_name', $user_actual ) ?>','<?php echo wp_get_current_user()->ID ?>','<?php echo get_post_meta( $id_tarea, '_job_salary', true ) ?>');">Ofertar</a>
                                    <?php }else { ?>
                                ...
                                <h6 class="">Detalle </h6>
                                <img src="<?php echo get_home_url().'/wp-content/uploads/'.job_meta_value_img($post_actual); ?>" >
                        ...
                        <div class="main-taks__presupuesto datos_presupuesto ">
                          ...
                          <div class="main-presupuesto__desktop">
                            <div class="presupuesto_minicard">
                              <p>Presupuesto</p>
                              <span class="precio">$<?php echo $job_salary ?></span>
