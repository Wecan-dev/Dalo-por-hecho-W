                    ...
                    <div id="accordion" role="tablist">
                        <div class="card">
                            ...
                            <div id="collapseOne" class="collapse show mb-5" role="tabpanel"
                                ...
                                <div class="card-body">
                                    <p>Indica en tu perfil tus aptitudes, medio de transporte,
certificados y/o cualidades, para tener mas posibilidades de adjudicar un trabajo
                                    </p>
                                                <?php
                                ...
                                <form method="post" id="adduser" action="<?php echo get_home_url(); ?>/save">
                                    ...
                                    <div class="form">
                                        ...
                                        <div class="col-md-12 check-line">                                          
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <label class="checkbox"> Carro
                                                    <?php if ($sinparametrosu[0] == 'Carro' OR $sinparametrosu[1] == 'Carro' OR $sinparametrosu[2] == 'Carro' OR $sinparametrosu[3] == 'Carro') { 
                                                        $checked4 = 'checked';?>
                                                    <?php } ?>                                                  
                                                    <input type="checkbox" class="apt" name="medio_de_transporte_user4" id="medio_de_transporte_user" value="Carro" <?php echo $checked4 ?>>
                                                    <span class="check"></span>
                                                </label>                                          
                                            </div>                                            
                                        </div>
                                        <div class="form mb-4">
                                            ...
                                            <input type="text"  placeholder="Cuales idiomas" id="idiomas_user" name="idiomas_user" value="<?php the_author_meta( 'idiomas_user', $current_user->ID ); ?>"/>
                                        </div>
                                        <div class="form mb-4">
                                        ...
                                        <div class="form mb-4">
                                            ...
                                            <textarea rows="10" cols="30" class="textarea-conf" placeholder="Donde ha trabajado y el tiempo" name="experiencia_user" id="experiencia_user"><?php the_author_meta( 'experiencia_user', $current_user->ID ); ?></textarea>                
                                        </div>
                                    </div>
