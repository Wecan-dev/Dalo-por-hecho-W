                                                                        ...
                                                                        <div class="contenido">
                                                                            <div class="datos_name"> 
                                                                                ...
                                                                                <div class="datos_genereal">
                                                                                    <div class="col-md-12">
                                                                                        <?php echo do_shortcode('[frm-set-get title_emblema='.$title_emblema.'][frm-set-get id_emblema='.get_the_ID().'][frm-set-get id_user_emblema='.$current_user->ID.'][frm-set-get user_emblema='.$current_user->user_login.'][formidable id=14]');  ?>
                                                                                    </div>       
                                                                                </div>              
                                                                            </div>
                                                                        </div>
