...
¿Olvidaste tu contraseña? Recupérala aquí. Escribe tu correo electrónico y recibe un enlace para restablecerla.
	...
	<p class="woocommerce-form-row form-row">
		...
		<button type="submit" class="main-general__btn main-general__button woocommerce-button woocommerce-form-login__submit" value="<?php esc_attr_e( 'Reset password', 'woocommerce' ); ?>"><?php esc_html_e( 'Reset password', 'woocommerce' ); ?></button>
	</p>
